...
contract Encoding {
    function combineStrings(string memory string0, string memory string1) public pure returns(string memory result) {
        /** 
    ...
    */
    ...
    function encodeNumber(uint256 input) public pure returns(bytes memory encodedResult) {
        encodedResult = abi.encode(input);
    }

    function encodeString(string memory input, bool packed) public pure returns(bytes memory encodedResult) {
    ...
    */
    ...
    // Multi-decoding
    function multiDecode() public pure returns(string memory part0, string memory part1) {
    ...
    function multiDecodePacked() public pure returns(string memory part0, string memory part1) {
